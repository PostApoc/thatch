...
class LibrarySidebar(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        header_lbl.setStyleSheet("font-weight: 900; font-size: 20px; color: #00e676; letter-spacing: 1px; padding: 4px;")
        ...
        self.btn_view_games.setStyleSheet("background-color: #1e291e; color: #00e676; border: 1px solid #00e676; font-weight: bold;")
        ...
        self.btn_view_envs.setStyleSheet("background-color: #202024; color: #a1a1aa; border: 1px solid #2d2d34;")
        ...
        self.btn_add.setStyleSheet("background-color: #202024; color: #00e676; border: 1px solid #2d2d34;")
    ...
    def _on_switch_to_envs(self) -> None:
        ...
        self.btn_view_envs.setStyleSheet("background-color: #1e291e; color: #00e5ff; border: 1px solid #00e5ff; font-weight: bold;")
        self.btn_view_games.setStyleSheet("background-color: #202024; color: #a1a1aa; border: 1px solid #2d2d34;")
