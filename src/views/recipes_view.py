...
class RecipesView(QWidget):
    ...
    def __init__(self, recipes_dir: Path, parent: QWidget | None = None) -> None:
        ...
        lbl_subtitle = QLabel("Crea y edita mapas del tesoro (configuraciones JSON) para tus contenedores.")
    ...
    def _on_save_recipe(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "Error de Formato", "Las variables de entorno deben estar en formato JSON válido.")
            return
