...
from PySide6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, 
                               ...
                               QComboBox, QWidget, QSizePolicy, QRadioButton, 
...
class CreateChestWizard(QDialog):
    ...
    def __init__(self, recipes: dict, runners: list[str], parent: QWidget | None = None) -> None:
        ...
        self.btn_back_header.setStyleSheet("background-color: transparent; border: none; color: #a1a1aa; font-weight: bold;")
    ...
    def _create_step2(self) -> QWidget:
        ...
        self.chk_sandbox_preset.setToolTip("Elimina accesos a carpetas reales como /home e independiza el prefijo para máxima seguridad.")
        ...
        self.txt_manual_display_name.setPlaceholderText("Nombre de Receta Personalizada (ej: Ultra Gaming)")
        ...
        self.chk_esync.setToolTip("Mejora el rendimiento general del juego y reduce el consumo del procesador (CPU).")
        
        self.chk_fsync = QCheckBox("WINEFSYNC = 1")
        self.chk_fsync.setChecked(True)
        self.chk_fsync.setToolTip("Aumenta los FPS en juegos (requiere un sistema Linux optimizado para gaming como Zen o CachyOS).")
        
        self.chk_laa = QCheckBox("PROTON_FORCE_LARGE_ADDRESS_AWARE = 1")
        self.chk_laa.setChecked(True)
        self.chk_laa.setToolTip("Evita cierres inesperados en juegos de 32 bits permitiéndoles usar más memoria RAM.")
        ...
        self.chk_sandbox.setToolTip("Elimina accesos a carpetas reales como /home e independiza el prefijo para máxima seguridad.")
    ...
    def _create_step4(self) -> QWidget:
        ...
        grid_frame = QFrame()
        grid_frame.setStyleSheet("background-color: #121214; border: 1px solid #2d2d34; border-radius: 8px; padding: 12px;")
        ...
        if self.current_step < 3:
            ...
            if self.current_step == 3:
                ...
                if is_preset:
                    ...
                    manual_display = self.txt_manual_display_name.text().strip() or f"Manual Custom ({name})"
                    env = manual_display
            ...
            if self.radio_preset.isChecked():
                ...
                display_name = self.txt_manual_display_name.text().strip() or f"Custom {name.replace('_',' ').title()}"
