...
class PreferencesView(QWidget):
    ...
    def __init__(self, db: ThatchDB, runners: list[str], parent: QWidget | None = None) -> None:
        ...
        self.lbl_specs_title.setStyleSheet("color: #ffffff; font-size: 13px; font-weight: bold; margin-top: 10px;")
    ...
    def retranslate(self) -> None:
        ...
        self._populate_runners_combo()
        if runner_text in ["System Wine (/usr/bin/wine)", "Wine del Sistema (/usr/bin/wine)"]:
